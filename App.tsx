...
const MainLayout = () => {
  ...
  useEffect(() => {
      if (homeContent) {
          ...
          if (ogTitle && homeContent.profile?.name) ogTitle.setAttribute('content', `${homeContent.profile.name} | Portfolio`);

          const ogDesc = document.querySelector('meta[property="og:description"]');
          if (ogDesc && homeContent.profile?.tagline) ogDesc.setAttribute('content', homeContent.profile.tagline);
      }
  }, [homeContent]);
